<template>
	<div class="product-page">
		...
		<MainImg :img="{ desktop: 'img-0108.jpg', mobile: 'img-0109.jpg' }" />
		...
		<BlockToSite :img="{ desktop: 'img-0112.jpg', tablet: 'img-0113.jpg', alt: 'partners img' }" :btn="{ href: '/' }" />
