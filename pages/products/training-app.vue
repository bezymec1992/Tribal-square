<template>
	<div class="product-page">
		...
		<MainImg :img="{ desktop: 'img-0100.jpg', mobile: 'img-0101.jpg' }" />
		...
		<BlockToSite :img="{ desktop: 'img-0105.jpg', tablet: 'img-0106.jpg', alt: 'partners img' }" :btn="{ href: '/' }" />
