<template>
	<div class="product-page">
		...
		<MainImg :img="{ desktop: 'img-079.jpg', mobile: 'img-080.jpg' }" />
		...
		<BlockToSite :img="{ desktop: 'img-085.jpg', tablet: 'img-086.jpg', alt: 'partners img' }" :btn="{ href: '/' }" />
