<template>
	<div class="product-page">
		<Intro-section class="product-page">
			<div class="container">
				<div class="row">
					<div class="col-12">
						<Breadcrumbs />
				...
				<div class="row align-items-md-center">
					...
					<div class="col-lg-5 d-md-flex justify-content-lg-end">
		...
		<MainImg :img="{ desktop: 'img-094.jpg', mobile: 'img-095.jpg' }" />
		...
		<SecondImg :img="{ desktop: 'img-096.png', mobile: 'img-097.png' }" :section-style="'max-width: 105.4rem'" />
		...
		<BlockToSite :img="{ desktop: 'img-097.jpg', tablet: 'img-098.jpg', alt: 'partners img' }" :btn="{ href: '/' }" />
...
import SectionThreeCols from "@/components/ProductPage/SectionThreeCols";
import BlockToSite from "@/components/ProductPage/BlockToSite";
import TextBlock from "@/components/ProductPage/TextBlock";
