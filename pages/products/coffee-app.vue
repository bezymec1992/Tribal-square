<template>
	<div class="product-page">
		...
		<MainImg :img="{ desktop: 'img-066.jpg', mobile: 'img-067.jpg' }" />
		...
		<BlockToSite :img="{ desktop: 'img-070.jpg', tablet: 'img-071.jpg', alt: 'partners img' }" :btn="{ href: '/' }" />
