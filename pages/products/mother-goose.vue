<template>
	<div class="product-page">
		...
		<MainImg :img="{ desktop: 'img-088.jpg', mobile: 'img-089.jpg' }" />
		...
		<SecondImg :img="{ desktop: 'img-090.png', mobile: 'img-091.png' }" :section-style="'max-width: 122.8rem'" />
		...
		<BlockToSite :img="{ desktop: 'img-092.jpg', tablet: 'img-093.jpg', alt: 'partners img' }" :btn="{ href: '/' }" />
