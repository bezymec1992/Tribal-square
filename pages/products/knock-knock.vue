<template>
	<div class="product-page">
		...
		<MainImg :img="{ desktop: 'img-072.jpg', mobile: 'img-073.jpg' }" />
		...
		<BlockToSite :img="{ desktop: 'img-076.jpg', tablet: 'img-077.jpg', alt: 'partners img' }" :btn="{ href: '/' }" />
