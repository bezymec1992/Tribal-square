<template>
    <div class="tribal-cyber">
				...
				<div class="row align-items-md-center">
					...
					<div class="col-lg-6">
						<div class="img-holder">
							<picture>
								<source srcset="@/assets/imgs/img-001.jpg" media="(min-width: 768px)" type="image/jpg" />
								<img src="@/assets/imgs/img-002.jpg" alt="Powwows" />
							</picture>
						</div>
					</div>
				</div>
        ...
        <SectionImg :img="{ desktop: 'img-003.jpg', mobile: 'img-004.jpg', alt: 'TribalDen img' }" />
        ...
        <SectionInfoBlock :img="{ desktop: 'img-005.jpg', mobile: 'img-006.jpg', alt: 'Services we provide' }" :btn="{ href: '/' }">
			<template #title>
				Services we provide
			</template>
			<template #list>
